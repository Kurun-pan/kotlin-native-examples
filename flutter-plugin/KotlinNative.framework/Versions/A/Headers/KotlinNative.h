...
@interface KotlinNativeObject : KotlinBase
...
@interface KotlinNativeRational : KotlinBase
- (instancetype)initWithNumerator:(int32_t)numerator denominator:(int32_t)denominator __attribute__((swift_name("init(numerator:denominator:)"))) __attribute__((objc_designated_initializer));
- (NSString *)description __attribute__((swift_name("description()")));
- (int32_t)result __attribute__((swift_name("result()")));
@property (readonly) int32_t numerator __attribute__((swift_name("numerator")));
@property (readonly) int32_t denominator __attribute__((swift_name("denominator")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("KotlinNativeKt")))
@interface KotlinNativeKotlinNativeKt : KotlinBase
+ (NSString * _Nullable)echoStr:(NSString *)str __attribute__((swift_name("echo(str:)")));
@property (class, readonly) NSString *globalString __attribute__((swift_name("globalString")));
@end;
